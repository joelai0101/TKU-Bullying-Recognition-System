...
# please change it to "gpu" if the model needs to be run on cuda.
device = "cpu"
...
model = load_model(
    "./video bully recognition/model325.h5")

# 加入openpose 使用的節點和抓取節點的模組
protoFile = "./video bully recognition/pose/coco/pose_deploy_linevec.prototxt"
weightsFile = "./video bully recognition/pose/coco/pose_iter_440000.caffemodel"
nPoints = 18
# COCO Output Format
